            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    functions.getArticleIntro(getJsonField(
                      widget.data,
                      r'''$.content.rendered''',
                    ).toString()),
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                ...
                Padding(
                  ...
                  child: Builder(
                    builder: (context) {
                      final lvIngredients = functions
                          .getArticleIngredients(getJsonField(
                            widget.data,
                            r'''$.content.rendered''',
                          ).toString())
                          .toList();
                      return ListView.builder(
                        ...
                        itemCount: lvIngredients.length,
                        itemBuilder: (context, lvIngredientsIndex) {
                          final lvIngredientsItem =
                              lvIngredients[lvIngredientsIndex];
                          return Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 10.0, 0.0, 0.0),
                            child: Row(
                ...
                Padding(
                  ...
                  child: Builder(
                    builder: (context) {
                      final lvPrepare = functions
                          .getArticlePrepare(getJsonField(
                            widget.data,
                            r'''$.content.rendered''',
                          ).toString())
                          .toList();
                      return ListView.builder(
                        ...
                        shrinkWrap: true,
                        scrollDirection: Axis.vertical,
                        itemCount: lvPrepare.length,
                        itemBuilder: (context, lvPrepareIndex) {
                          final lvPrepareItem = lvPrepare[lvPrepareIndex];
                          return Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 10.0, 0.0, 0.0),
                            child: Row(
                              ...
                              children: [
                                Text(
                                  functions
                                      .setPrepareNumber(lvPrepareIndex)
                                      .toString(),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                _model.postCommentResult =
                                  ...
                                  message: _model.comentarioController.text,
                                );
